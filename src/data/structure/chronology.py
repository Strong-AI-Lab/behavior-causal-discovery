...
class Chronology:
    ...
    @classmethod
    def create(cls, file_path : Union[str, List[str]], fix_errors : bool = False, filter_null_state_trajectories : bool = False, parser : Optional[Parser] = None) -> 'Chronology':
        if parser is None:
            from data.parsers.pandasparser import PandasParser # Avoid circular import
