...
parser.add_argument('--discriminator_type', type=str, default="lstm", choices=DISCRIMINATORS.keys(), help=f'Type of discriminator to use. Options: {",".join(DISCRIMINATORS.keys())}.')
