...
parser.add_argument('--mode', type=str, default="dynamic", choices=GENERATOR_MODE_LOADER.keys(), help=f'Mode of the generator. Options: {",".join(GENERATOR_MODE_LOADER.keys())}.')
